...
type
  OrtApi* = object
    ...
    CreateEnv*: proc(log_severity_level: OrtLoggingLevel, logid: cstring, out: ptr ptr OrtEnv): ptr OrtStatus
    CreateEnvWithCustomLogger*: proc(logging_function: proc(param: pointer, severity: OrtLoggingLevel, category: cstring, logid: cstring, code_location: cstring, message: cstring), logger_param: pointer, log_severity_level: OrtLoggingLevel, logid: cstring, out: ptr ptr OrtEnv): ptr OrtStatus
    EnableTelemetryEvents*: proc(env: ptr OrtEnv): ptr OrtStatus
    DisableTelemetryEvents*: proc(env: ptr OrtEnv): ptr OrtStatus
    CreateSession*: proc(env: ptr OrtEnv, model_path: cstring, options: ptr OrtSessionOptions, out: ptr ptr OrtSession): ptr OrtStatus
    CreateSessionFromArray*: proc(env: ptr OrtEnv, model_data: pointer, model_data_length: csize, options: ptr OrtSessionOptions, out: ptr ptr OrtSession): ptr OrtStatus
    ...
    CreateCustomOpDomain*: proc(domain: cstring, out: ptr ptr OrtCustomOpDomain): ptr OrtStatus
    ...
    SessionGetInputCount*: proc(session: ptr OrtSession, out: ptr csize): ptr OrtStatus
    SessionGetOutputCount*: proc(session: ptr OrtSession, out: ptr csize): ptr OrtStatus
    SessionGetOverridableInitializerCount*: proc(session: ptr OrtSession, out: ptr csize): ptr OrtStatus
    ...
    SessionGetInputName*: proc(session: ptr OrtSession, index: csize, allocator: ptr OrtAllocator, value: ptr cstring): ptr OrtStatus
    SessionGetOutputName*: proc(session: ptr OrtSession, index: csize, allocator: ptr OrtAllocator, value: ptr cstring): ptr OrtStatus
    SessionGetOverridableInitializerName*: proc(session: ptr OrtSession, index: csize, allocator: ptr OrtAllocator, value: ptr cstring): ptr OrtStatus
    CreateRunOptions*: proc(out: ptr ptr OrtRunOptions): ptr OrtStatus
    ...
    CreateTensorAsOrtValue*: proc(allocator: ptr OrtAllocator, shape: ptr int64, shape_len: csize, `type`: ONNXTensorElementDataType, out: ptr ptr OrtValue): ptr OrtStatus
    CreateTensorWithDataAsOrtValue*: proc(info: ptr OrtMemoryInfo, p_data: pointer, p_data_len: csize, shape: ptr int64, shape_len: csize, `type`: ONNXTensorElementDataType, out: ptr ptr OrtValue): ptr OrtStatus
    IsTensor*: proc(value: ptr OrtValue, out: ptr cint): ptr OrtStatus
    GetTensorMutableData*: proc(value: ptr OrtValue, out: ptr pointer): ptr OrtStatus
    ...
    CastTypeInfoToTensorInfo*: proc(type_info: ptr OrtTypeInfo, out: ptr (ptr OrtTensorTypeAndShapeInfo)): ptr OrtStatus
    GetOnnxTypeFromTypeInfo*: proc(type_info: ptr OrtTypeInfo, out: ptr ONNXType): ptr OrtStatus
    CreateTensorTypeAndShapeInfo*: proc(out: ptr ptr OrtTensorTypeAndShapeInfo): ptr OrtStatus
    ...
    GetTensorElementType*: proc(info: ptr OrtTensorTypeAndShapeInfo, out: ptr ONNXTensorElementDataType): ptr OrtStatus
    GetDimensionsCount*: proc(info: ptr OrtTensorTypeAndShapeInfo, out: ptr csize): ptr OrtStatus
    ...
    GetTensorShapeElementCount*: proc(info: ptr OrtTensorTypeAndShapeInfo, out: ptr csize): ptr OrtStatus
    GetTensorTypeAndShape*: proc(value: ptr OrtValue, out: ptr ptr OrtTensorTypeAndShapeInfo): ptr OrtStatus
    GetTypeInfo*: proc(value: ptr OrtValue, out: ptr ptr OrtTypeInfo): ptr OrtStatus
    GetValueType*: proc(value: ptr OrtValue, out: ptr ONNXType): ptr OrtStatus
    CreateMemoryInfo*: proc(name: cstring, `type`: cint, id: cint, mem_type: cint, out: ptr ptr OrtMemoryInfo): ptr OrtStatus
    CreateCpuMemoryInfo*: proc(`type`: cint, mem_type: cint, out: ptr ptr OrtMemoryInfo): ptr OrtStatus
    CompareMemoryInfo*: proc(info1: ptr OrtMemoryInfo, info2: ptr OrtMemoryInfo, out: ptr cint): ptr OrtStatus
    MemoryInfoGetName*: proc(ptr: ptr OrtMemoryInfo, out: ptr cstring): ptr OrtStatus
    MemoryInfoGetId*: proc(ptr: ptr OrtMemoryInfo, out: ptr cint): ptr OrtStatus
    MemoryInfoGetMemType*: proc(ptr: ptr OrtMemoryInfo, out: ptr cint): ptr OrtStatus
    MemoryInfoGetType*: proc(ptr: ptr OrtMemoryInfo, out: ptr cint): ptr OrtStatus
    AllocatorAlloc*: proc(ort_allocator: ptr OrtAllocator, size: csize, out: ptr pointer): ptr OrtStatus
    AllocatorFree*: proc(ort_allocator: ptr OrtAllocator, p: pointer): ptr OrtStatus
    AllocatorGetInfo*: proc(ort_allocator: ptr OrtAllocator, out: ptr (ptr OrtMemoryInfo)): ptr OrtStatus
    GetAllocatorWithDefaultOptions*: proc(out: ptr ptr OrtAllocator): ptr OrtStatus
    AddFreeDimensionOverride*: proc(options: ptr OrtSessionOptions, dim_denotation: cstring, dim_value: int64): ptr OrtStatus
    GetValue*: proc(value: ptr OrtValue, index: cint, allocator: ptr OrtAllocator, out: ptr ptr OrtValue): ptr OrtStatus
    GetValueCount*: proc(value: ptr OrtValue, out: ptr csize): ptr OrtStatus
    CreateValue*: proc(in_val: ptr (ptr OrtValue), num_values: csize, value_type: ONNXType, out: ptr ptr OrtValue): ptr OrtStatus
    CreateOpaqueValue*: proc(domain_name: cstring, type_name: cstring, data_container: pointer, data_container_size: csize, out: ptr ptr OrtValue): ptr OrtStatus
    ...
    KernelInfoGetAttribute_float*: proc(info: ptr OrtOp, name: cstring, out: ptr float): ptr OrtStatus
    KernelInfoGetAttribute_int64*: proc(info: ptr OrtOp, name: cstring, out: ptr int64): ptr OrtStatus
    KernelInfoGetAttribute_string*: proc(info: ptr OrtOp, name: cstring, out: cstring, size: ptr csize): ptr OrtStatus
    KernelContext_GetInputCount*: proc(context: ptr OrtOp, out: ptr csize): ptr OrtStatus
    KernelContext_GetOutputCount*: proc(context: ptr OrtOp, out: ptr csize): ptr OrtStatus
    KernelContext_GetInput*: proc(context: ptr OrtOp, index: csize, out: ptr (ptr OrtValue)): ptr OrtStatus
    KernelContext_GetOutput*: proc(context: ptr OrtOp, index: csize, dim_values: ptr int64, dim_count: csize, out: ptr ptr OrtValue): ptr OrtStatus
    ...
    SessionEndProfiling*: proc(session: ptr OrtSession, allocator: ptr OrtAllocator, out: ptr cstring): ptr OrtStatus
    SessionGetModelMetadata*: proc(session: ptr OrtSession, out: ptr ptr OrtModelMetadata): ptr OrtStatus
    ...
    CreateEnvWithGlobalThreadPools*: proc(log_severity_level: OrtLoggingLevel, logid: cstring, tp_options: ptr OrtThreadingOptions, out: ptr ptr OrtEnv): ptr OrtStatus
    DisablePerSessionThreads*: proc(options: ptr OrtSessionOptions): ptr OrtStatus
    CreateThreadingOptions*: proc(out: ptr ptr OrtThreadingOptions): ptr OrtStatus
    ...
    GetAvailableProviders*: proc(out_ptr: ptr (ptr cstring), provider_length: ptr cint): ptr OrtStatus
    ReleaseAvailableProviders*: proc(ptr: ptr cstring, providers_length: cint): ptr OrtStatus
    GetStringTensorElementLength*: proc(value: ptr OrtValue, index: csize, out: ptr csize): ptr OrtStatus
    ...
    CreateAllocator*: proc(session: ptr OrtSession, mem_info: ptr OrtMemoryInfo, out: ptr ptr OrtAllocator): ptr OrtStatus
    ...
    CreateIoBinding*: proc(session: ptr OrtSession, out: ptr ptr OrtIoBinding): ptr OrtStatus
    ...
    TensorAt*: proc(value: ptr OrtValue, location_values: ptr int64, location_values_count: csize, out: ptr pointer): ptr OrtStatus
    ...
    SessionGetProfilingStartTimeNs*: proc(session: ptr OrtSession, out: ptr uint64): ptr OrtStatus
